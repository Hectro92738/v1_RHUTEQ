...
<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Subir XML y PDF </div>
					<div class="panel-body">
						<div class="col-lg-12 form-group">
							<div class="form-group">
							  <form name="MiForm" id="MiForm" method="post" action="cargarArchivos.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
								...
								<button type="submit" class="btn btn-primary">Cargar archivos .zip XML y PDF </button>
                            	</div>
							</div>
							  </form>
						</div>
